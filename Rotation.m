...
broj=Length[list];
Do[Subscript[g,i]=Graphics3D[GeometricTransformation[ExampleData[{"Geometry3D","Cow"},"GraphicsComplex"],RotationTransform[2PolarForm[list[[i]]][[1]],PolarForm[list[[i]]][[2]]]]],{i,1,broj}];
...
Do[Subscript[g,i]=Graphics3D[GeometricTransformation[ExampleData[{"Geometry3D","Cow"},"GraphicsComplex"],RotationTransform[2PolarForm[Subscript[Quat,i][tt][[1]]][[1]],PolarForm[Subscript[Quat,i][tt][[1]]][[2]]]
],SphericalRegion->True],{i,1,n}];
Grid[ArrayReshape[Table[Subscript[g,i],{i,1,n}],{1,n}]]]


SimulationInterpolation[time_]:=Module[{tt=time,g1,g2},g1=Graphics3D[GeometricTransformation[ExampleData[{"Geometry3D","Cow"},"GraphicsComplex"],RotationTransform[2PolarForm[ToQuaternion[fun[tt][[1]]]][[1]],PolarForm[ToQuaternion[fun[tt][[1]]]][[2]]]],SphericalRegion->True];g2=Graphics3D[GeometricTransformation[ExampleData[{"Geometry3D","Cow"},"GraphicsComplex"],RotationTransform[2PolarForm[k2][[1]],PolarForm[k2][[2]]]],SphericalRegion->True];
Grid[{{g1,g2}}]
];


SimulationDistribSync[time_]:=Module[{tt=time,gg},
Do[Subscript[gg,i]=Show[Graphics3D[If[tt<=tc,GeometricTransformation[ExampleData[{"Geometry3D","Cow"},"GraphicsComplex"],RotationTransform[2PolarForm[ToQuaternion[Subscript[fun2,i][tt][[1]]]][[1]],PolarForm[ToQuaternion[Subscript[fun2,i][tt][[1]]]][[2]]]],SphericalRegion->True]],
Graphics3D[If[tt>=tc,GeometricTransformation[ExampleData[{"Geometry3D","Cow"},"GraphicsComplex"],RotationTransform[2PolarForm[ToQuaternion[Subscript[fun3,i][tt-tc][[1]]]][[1]],PolarForm[ToQuaternion[Subscript[fun3,i][tt-tc][[1]]]][[2]]]]],SphericalRegion->True],SphericalRegion->True],{i,1,nn}];
